                        ...
                        return (
                          <Grid item xs={12} key={index}>
                            <React.Fragment>
                              ...
                              <RadioGroup name={key} value={this.state.inputs[key] || ""} onChange={this.onChange} style={style}>
                                {items.map((item, index) => {
                                  const value = item.value;
                                  const label = item.label || "";

                                  return <FormControlLabel key={index} value={value} control={<Radio />} label={label} />;
                                })}
                              </RadioGroup>
                            </React.Fragment>
                          </Grid>
